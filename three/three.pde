...
class SelectState implements IState{
  ...
  public IState update(){
    ...
    for(int i=0; i<player01Deck.cardList.size(); i++){
      renderBack(300, 370 + i * 5, 50/2, 80/2);
    }
    for(int i=0; i<player02Deck.cardList.size(); i++){
      renderBack(25, 50 + i * 5, 50/2, 80/2);
    }
...
class DecideState implements IState{
  ...
  public IState update(){
    ...
    renderCard(this.playerCard, new PVector(width/2, 300 - 15));
    renderCard(this.enemyCard, new PVector(width/2, 180 + 15));
...
class TitleState implements IState{
  ...
  public IState update(){
    image(SpriteFinder.getSprite("three_top.png"), width/2, height/2);
...
void renderCard(Card card, PVector pos){
  ...
  if(card.playerId == 1){
    if(card.type == 1){
      if(card.strength == 1) file = "1r1@4x.png";
      if(card.strength == 2) file = "1r2@4x.png";
      if(card.strength == 3) file = "1r3@4x.png";
    }
    if(card.type == 2){
      if(card.strength == 1) file = "1b1@4x.png";
      if(card.strength == 2) file = "1b2@4x.png";
      if(card.strength == 3) file = "1b3@4x.png";
    }
    if(card.type == 3){
      if(card.strength == 1) file = "1y1@4x.png";
      if(card.strength == 2) file = "1y2@4x.png";
      if(card.strength == 3) file = "1y3@4x.png";
    }
  }
  if(card.playerId == 2){
    if(card.type == 1){
      if(card.strength == 1) file = "2r1@4x.png";
      if(card.strength == 2) file = "2r2@4x.png";
      if(card.strength == 3) file = "2r3@4x.png";
    }
    if(card.type == 2){
      if(card.strength == 1) file = "2b1@4x.png";
      if(card.strength == 2) file = "2b2@4x.png";
      if(card.strength == 3) file = "2b3@4x.png";
    }
    if(card.type == 3){
      if(card.strength == 1) file = "2y1@4x.png";
      if(card.strength == 2) file = "2y2@4x.png";
      if(card.strength == 3) file = "2y3@4x.png";
    }
  }
  ...
  image(SpriteFinder.getSprite(file), 0, 0, 70 * 0.8, 100 * 0.8);
  popMatrix();
}
void renderBack(float x, float y, float w, float h){
  image(SpriteFinder.getSprite("com@4x.png"), x, y, w, h);
}
